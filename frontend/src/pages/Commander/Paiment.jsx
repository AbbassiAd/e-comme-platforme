  ...
  const createOrdres = async () => {
    try {
      ...
      if (res.error) {
        ...
        toast.success(`Ordre created successfully`);
        ...
        {currentStep === 1 && (
          <div className="mb-4">
            ...
            <button
              ...
              className="bg-black ml-[380px] hover:bg-black-700 text-white h-[50px] w-[200px] rounded focus:outline-none focus:shadow-outline mt-4"
            >
              ...
              <div className="w-full md:w-3/4 lg:w-1/2">
                <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                  <div className="p-8 lg:p-12">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          <input
                            type="text"
                            id="cname"
                            className="block w-full py-2 px-3 border border-gray-300 rounded-lg focus:outline-none focus:border-blue-500"
                            value={cardName}
                    ...
                    <button
                      onClick={ handleNextStep}
                      className="mt-8 w-full bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-3 px-4 rounded-lg focus:outline-none focus:shadow-outline"
                      type="button"
                    >
